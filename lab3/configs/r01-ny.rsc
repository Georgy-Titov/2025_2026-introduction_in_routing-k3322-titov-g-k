...
/system identity set set name=R01.NY

/ip address
add address=10.10.6.2/30 interface=ether2
add address=10.10.7.2/30 interface=ether3
add address=192.168.11.1/24 interface=ether4

/ip pool
add name=dhcp-pool ranges=192.168.11.10-192.168.11.254
/ip dhcp-server
...
add area=backbonev2 network=10.10.6.0/30
add area=backbonev2 network=10.10.7.0/30
