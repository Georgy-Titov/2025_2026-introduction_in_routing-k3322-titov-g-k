...
/ip address
add address=10.10.4.2/30 interface=ether2
add address=10.10.5.2/30 interface=ether3
add address=10.10.7.1/30 interface=ether4
...
add area=backbonev2 network=10.10.5.0/30
