...
add address=10.10.5.1/30 interface=ether3
add address=10.10.3.1/30 interface=ether4
...
add area=backbonev2 network=10.10.1.0/30
add area=backbonev2 network=10.10.3.0/30
