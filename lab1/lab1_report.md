...
В ходе выполнения лабораторной работы №1 я освоил основы работы с инструментом ContainerLab, научился описывать топологию сети в YAML-файле и развертывать виртуальные сетевые устройства (RouterOS и Linux). Было реализовано подключение узлов в трёхуровневой архитектуре, настроены VLAN-ы, DHCP-сервера и IP-адресация, а также проверена связность между конечными устройствами.
